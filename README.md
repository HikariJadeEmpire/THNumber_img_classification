...
![cap0](https://github.com/HikariJadeEmpire/THNumber_img_classification-dash_app-/assets/118663358/aa3d9c75-a53b-4b92-9723-7f388194c5d9)
  ...
  *NOTE :* Score และ Model อาจมีการเปลี่ยนแปลง เนื่องจากมีการ Re-sampling DATA ในทุกๆครั้งที่ Train <br>
  ...
  สำหรับหน้าแรก จะมีไว้สำหรับ 📥 import **.CSV** file ( ที่ได้จาก [การทำ Machine Learning (ML)](https://github.com/HikariJadeEmpire/THNumber_img_classification-dash_app-#%E0%B8%81%E0%B8%B2%E0%B8%A3%E0%B8%97%E0%B8%B3-machine-learning-ml) ) เพื่อการนำไปใช้งาน <br>
  ...
  **Cross Validation** 
  ...
  โดยผลลัพธ์ที่ได้หลักจากการ *เลือก หรือ ตั้งค่า Model* เสร็จแล้ว ก็จะออกมาเป็น Graph 📈 สำหรับการเปรียบเทียบคะแนนโดยเฉลี่ยของแต่ละ Model <br>
